package com.franz.sud.java.game.platform.cartridge.castlevania.service;
...
import com.franz.sud.java.game.platform.cartridge.castlevania.IO;
...
public class InventoryService {
    ...
    public void openInventoryMenu() {
        ...
        input.put("a", "Show equipped items");
    ...
    /**
     * Shows the current items in possession of the player. If the list passed in the parameter
    ...
    private void showEquippedItem() {
        IO.showEquippedItem(equippedItem);
    }
}
