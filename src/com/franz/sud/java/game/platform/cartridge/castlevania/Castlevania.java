package com.franz.sud.java.game.platform.cartridge.castlevania;

import com.franz.sud.java.game.platform.cartridge.Cartridge;
import com.franz.sud.java.game.platform.cartridge.castlevania.elements.GameMap;
import com.franz.sud.java.game.platform.cartridge.castlevania.elements.GameProgress;
import com.franz.sud.java.game.platform.cartridge.castlevania.elements.item.*;
import com.franz.sud.java.game.platform.cartridge.castlevania.elements.Narrative;
import com.franz.sud.java.game.platform.cartridge.castlevania.elements.skill.*;
import com.franz.sud.java.game.platform.cartridge.castlevania.elements.unit.Enemy;
import com.franz.sud.java.game.platform.cartridge.castlevania.elements.unit.Hero;
import com.franz.sud.java.game.platform.cartridge.castlevania.elements.unit.SkilledEnemy;
import com.franz.sud.java.game.platform.cartridge.castlevania.service.BattleService;
import com.franz.sud.java.game.platform.cartridge.castlevania.service.InventoryService;
import com.franz.sud.java.game.platform.cartridge.castlevania.service.MapService;
import com.franz.sud.java.game.platform.cartridge.castlevania.service.RoomService;
...
public class Castlevania implements Cartridge {
    ...
    private void checkProgress() {
        ...
        if (progress.getProgress() == MAP_CHANGE) {
    ...
    private void getNarrative(int index) {
        ...
        if (!narrativeList.containsKey(currRoom)) return;
    ...
    private void dropConsumable(Enemy enemy) {
        ...
        IO.printDroppedConsumable(cons.getName(), enemy.getName());
    ...
    public void init() {
        ...
        SoulSteal soulSteal = new SoulSteal("Soulsteal");
        ChaosStrike chaosStrike = new ChaosStrike("Chaos Strike");
        ...
        String[] introduction = new String[] {
                ...
                "",
                "Press M to move around the map."
        };
