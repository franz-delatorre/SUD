package com.franz.sud.java.game.cartridge.castlevania.io;
...
import com.franz.sud.java.game.platform.dungeon_crawler.components.Item;
import com.franz.sud.java.game.platform.dungeon_crawler.components.Skill;
import com.franz.sud.java.game.platform.dungeon_crawler.components.Stats;
import com.franz.sud.java.game.platform.dungeon_crawler.components.Unit;
...
import static com.franz.sud.java.game.cartridge.castlevania.io.Sleep.sleep;
import static com.franz.sud.java.game.cartridge.castlevania.io.TextColor.ANSI_RESET;
import static com.franz.sud.java.game.cartridge.castlevania.io.TextColor.ANSI_PURPLE;
import static com.franz.sud.java.game.cartridge.castlevania.io.TextColor.ANSI_GREEN;
import static com.franz.sud.java.game.cartridge.castlevania.io.TextColor.ANSI_RED;
import static com.franz.sud.java.game.cartridge.castlevania.io.TextColor.ANSI_CYAN;
import static com.franz.sud.java.game.cartridge.castlevania.io.TextColor.ANSI_BLUE;
import static com.franz.sud.java.game.cartridge.castlevania.io.TextColor.ANSI_BLACK;
...
//        sleep(1);
    ...
    public static String pickupItem() {
        ...
        if (s.equals("y")) System.out.println(ANSI_GREEN + "Item is added to your inventory" + ANSI_BLACK);
        return s;
    }
    ...
    public static void printStatBoostDeactivate(GameStats stats) {
        for (StatType stat: StatType.values()) {
            ...
            if (statValue > 0)
                System.out.println(ANSI_RED + "- " + statValue + ANSI_BLACK);
        }
    }
}
